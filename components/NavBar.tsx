    ...
    <nav className="backdrop-blur-sm w-[100vw] h-[50px] sticky  top-0 py-8">
      <div className="py-[12px] w-[85%] max-w-[1200px] relative  top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] border-b-[--border] border-b-[1px] flex justify-between items-center ">
        ...
        <div
          className={
            isClicked
              ? "top-[0] left-[-9%]  transition-all gap-14 font-display items-center justify-center bg-gray-900 text-[2rem] flex flex-col absolute  w-[100vw] h-[100vh]  md:hidden"
              : "top-[0] left-[120%]  transition-all gap-8 font-display items-center justify-center bg-gray-900 text-[2rem] flex flex-col absolute  w-[100vw] h-[100vh]  md:hidden"
          }
        >
          <Link
            href="/"
