export default function Home() {
  return (
    <section id="terms" className="max-w-[1200px] mx-auto  px-6">
      <div>
        ...
        <article>
          ...
          the Client's needs in respect of the provision of the Company's stated
          services/products, under and subject to, prevailing law of. Any use of
          the above terminology or other words in the singular, plural,
          capitalization, and he/she or they, are taken as interchangeable and,
          therefore, referring to the same.
          <br />
          <br />
          <b>Cookies</b>
          <br />
          ...
          areas of our site to allow this area's functionality and ease of use
          ...
          indecent, or otherwise unlawful material or material invasion of
          privacy.
          <br />
          ...
          written approval:
          <br />
          (a)Government agencies (b)Search engines (c)News organizations
          (d)Online directory distributors, when they list us in the directory,
          may link to our Web site in the same manner as they hyperlink to the
          Web sites of other listed businesses (e)Systemwide Accredited
          Businesses except soliciting non-profit organizations, charity
          shopping malls, and charity fundraising groups may not hyperlink to
          our Web site.
          <br />
          <br />
          <b>
          ...
          <br />
          commonly-known consumer and business information sources such as
          ...
          or
          <br />
          Using any other description of our Web site or material being linked
          ...
          infringement other violation of any third party rights.
          <br />
          <br />
          ...
          objectionable, you may contact us about this. We will consider
          requests to remove links but will have no obligation to do so or to
          ...
          commit to ensuring that the website remains available or that the web
          site's material is kept up to date.
          <br />
          <br />
          <b>Disclaimer</b>
          <br />
          ...
          or concerning the subject matter of this disclaimer, including
